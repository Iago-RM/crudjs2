...
async function editarAluno(id) {
  ...
  document.getElementById("up-nome").value = aluno.aluno.nome;
  document.getElementById("up-nasc").value =
    aluno.aluno.data_nascimento;
  document.getElementById("up-nota1").value =
    aluno.aluno.nota_primeiro_semestre;
  document.getElementById("up-nota2").value =
    aluno.aluno.nota_segundo_semestre;
  document.getElementById("up-turma").value = aluno.aluno.turma_id;
...
document.getElementById("update-form").addEventListener("submit", async (e) => {
  ...
  const data = {
    nome: form["upup-nome"].value,
    data_nascimento: form["up-nasc"].value,
